...
import { findTool, groupByCategory, routerPath, toolRoutes } from "@devtools/tools-core";
  ...
  return (
    <div className="home">
      <section className="home-hero">
        <h1 className="home-hero__title">Developer tools that never upload your data</h1>
        <p className="home-hero__lede">
          {toolRoutes.length} utilities that run entirely in your browser. No account, no server, no
          file leaves your machine — open the network tab and check.
        </p>
