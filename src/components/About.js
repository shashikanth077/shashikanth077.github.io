          ...
          <div className="about_inner">
            <div className="left">
              <div className="image_wrap">
                <Image src="/img/about/1.png" alt="image" width={400} height={400} />
                <div className="main" data-img-url="/img/about/2.png" />
                <div className="extra_image">
                  <div className="image_inner">
                    <Image src="/img/about/1.png" alt="" width={300} height={300} />
                    <div
                ...
                {aboutData.skillIcons.map((skill, i) => (
                  <div className={i === 0 ? "extra_image" : ""} key={i}>
                    ...
                    >
                      <Image className="svg" src={skill.icon} alt="" width={50} height={50} />
                    </span>
                  </div>
                ))}
              </div>
